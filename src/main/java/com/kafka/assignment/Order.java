...
public class Order extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2296289345191176365L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Order\",\"namespace\":\"com.kafka.assignment\",\"fields\":[{\"name\":\"orderId\",\"type\":\"string\"},{\"name\":\"product\",\"type\":\"string\"},{\"name\":\"price\",\"type\":\"float\"}]}");
   ...
   */
  public static com.kafka.assignment.Order.Builder newBuilder() {
    return new com.kafka.assignment.Order.Builder();
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static com.kafka.assignment.Order.Builder newBuilder(com.kafka.assignment.Order.Builder other) {
    if (other == null) {
      return new com.kafka.assignment.Order.Builder();
    } else {
      return new com.kafka.assignment.Order.Builder(other);
    }
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static com.kafka.assignment.Order.Builder newBuilder(com.kafka.assignment.Order other) {
    if (other == null) {
      return new com.kafka.assignment.Order.Builder();
    } else {
      return new com.kafka.assignment.Order.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Order>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kafka.assignment.Order.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kafka.assignment.Order other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.assignment.Order.Builder setOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.assignment.Order.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.assignment.Order.Builder setProduct(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.assignment.Order.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.assignment.Order.Builder setPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.assignment.Order.Builder clearPrice() {
